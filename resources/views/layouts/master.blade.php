        ...
        <div class="list-group panel">
            ...
            @if(Entrust::hasRole('administrator') || Entrust::hasRole('owner'))
                ...
                <div class="collapse" id="data">
                    <a href="{{ route('data.management')}}" class="list-group-item childlist">
                        <i class="bullet-point"><span></span></i> {{ __('Data Management') }}
                    </a>
                </div>

                <a href="#import" class=" list-group-item" data-toggle="collapse" data-parent="#MainMenu">
                    <i class="fa fa-upload sidebar-icon"></i><span id="menu-txt">{{ __('Import Data') }}</span>
